...
Code.prototype = {
    ...
    _createPanel: function _createPanel(value) {
        ...
        var panel = new Panel(this, {
            ...
            tabs: [{
                // 标题
                title: '插入代码'+"<select id='selg' value=''>" +
				"<option value='brush:java;'>请选择</option>" +
				"<option value='brush:java'>java</option>" +
				"<option value='brush:c#'>c#</option>" +
				"<option value='brush:html'>html</option>" +
				"</select>" ,
                // 模板
    ...
    _insertCode: function _insertCode(value) {
       ...
       /* var str = "<select id='selg' value=''>" +
        ...
        editor.cmd.do('insertHTML', '<pre id="precode" class="syntaxhighlighter ">' + value + '</pre><p><br></p>');
        
        $("#precode").addClass($("#selg").val());
